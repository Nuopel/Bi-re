...
<<<<<<< HEAD
	...
	\chapter*{Fabrication Bière 1 : Kit Tarwebier blanche}
		...
		\section{Nettoyage}
			...
			\begin{figure}[h!]
				\centering
				\includegraphics[width=200px]{./photos/nettoyage2b.JPG}
				\caption{Nettoyage du matériel}
				\label{netoyage}
			\end{figure}
			\begin{figure}[h!]
				\centering
				\includegraphics[width=200px]{./photos/chemichemiprob.JPG}
		...
		\section{L'empâtage, infusion du malt et houblonnage} 
			Dire que j'ai fais l'empâtage,l'infusion et le houblonnage est un bien grand titre pour pas grand chose, j'ai réchauffé au bain marie une boite de conserve. \\
			 \begin{figure}[h!]
			 	\centering
			 	\includegraphics[width=200px]{./photos/conserve1b.JPG}
			...
			\begin{figure}[h!]
				\centering
				\includegraphics[width=200px]{./photos/Matosb.JPG}
				\caption{Le matériel.}
				\label{matos}
			\end{figure}
			...
			\begin{figure}[h!]
				\centering
				\includegraphics[width=200px]{./photos/cuve3b.JPG}
				\caption{Ajout de la boite de conserve}
				\label{cuve}
			\end{figure}
			\begin{figure}[h!]
			\centering
			\includegraphics[width=200px]{./photos/cuveremplieb.JPG}
			...
			\begin{figure}[h!]
				\centering
				\includegraphics[width=200px]{./photos/levureb.JPG}
			...
			\begin{figure}[h!]
				\centering
				\includegraphics[width=200px]{./photos/refroidissementb.JPG}
		...
		\section{Fermentation 1}
			...
			\begin{figure}[h!]
				\centering
				\includegraphics[width=200px]{./photos/cuveCacheb.JPG}
				\caption{Cuve caché !}
				\label{cuvec}
			\end{figure}
			Finalement on voit sur la photo que le barboteur bloblote ! Donc tout va bien !
			 \begin{figure}[h!]
			 	\centering
			 	\includegraphics[width=200px]{./photos/blob2b.JPG}
